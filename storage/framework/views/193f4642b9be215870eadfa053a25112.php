...
<script>
    ...
    const x = setInterval(function() {
        ...
        if (distance < 0) {
            clearInterval(x);
            document.querySelector(".countdown-section").innerHTML = "EXPIRED";
        }
    }, 1000);
</script><?php /**PATH C:\xampp\htdocs\owaismart\resources\views/frontend/flashsale/index.blade.php ENDPATH**/ ?>