<section class="product arrival">
    <div class="container">
        <div class="section-title">
            <h5>Our Products</h5>
            <a href="<?php echo e(route('products.sidebar')); ?>" class="view">View All</a>
        </div>
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                ...
                                <span class="Product" style="font-size: 1.5em; font-weight: bold;"><?php echo e($product->prod); ?></span>
...
</section><?php /**PATH C:\xampp\htdocs\owaismart\resources\views/frontend/new_arrival/index.blade.php ENDPATH**/ ?>