<section class="product weekly-sale">
    <div class="container">
        ...
        <div class="weekly-sale-section">
            <div class="row g-5">
<?php $__currentLoopData = $bestsales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bestsale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <div class="col-lg-3 col-md-6">

                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="/uploads/bestsale_img/<?php echo e($bestsale->p_img); ?>" class="card-img-top" alt="product-img">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <a href="product-info.html" class="product-details"><?php echo e($bestsale->prod); ?> </a>
                                <div class="price">
                                    <span class="price-cut"><?php echo e($bestsale->prod_price); ?></span>
                                    <span class="new-price"><?php echo e($bestsale->selling_price); ?></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="style-section">
            <div class="row gy-4 gx-5 gy-lg-0">
                <div class="col-lg-6">
                    <div class="product-wrapper wrapper-one" data-aos="fade-right" style="background-image: url('your-image-url.jpg'); background-size: cover; background-position: center;">
...
</section><?php /**PATH C:\xampp\htdocs\owaismart\resources\views/frontend/bestsale/index.blade.php ENDPATH**/ ?>