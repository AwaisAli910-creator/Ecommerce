<section class="product footer">
    <style>
        .product.footer {
            ...
            background-image: url('/uploads/footer_img/footer.jpg'); /* Replace with your image path */
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        ...
                        <div class="footer-link order-link">
                            <ul>
                                <li><a href="<?php echo e(route('ordertracking.index')); ?>">Track Order</a></li>
                                <li><a href="<?php echo e(route('cart.index')); ?>">Delivery & Returns</a></li>
                                <li><a href="<?php echo e(route('frontend.aboutus')); ?>">Warranty</a></li>
                            </ul>
                        </div>
...
</section><?php /**PATH C:\xampp\htdocs\owaismart\resources\views/frontend/body/footer.blade.php ENDPATH**/ ?>