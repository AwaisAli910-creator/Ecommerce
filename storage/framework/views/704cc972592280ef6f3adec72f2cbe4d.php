                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="mb-0 font-14">#<?php echo e($order->order_number); ?></h6>
                                        </div>
                                    </div>
                                </td>
                                <td><?php echo e($order->order_date); ?></td>
                                <td><?php echo e($order->cus_fname . $order->cus_lname); ?></td> <!-- Updated from company_name to customer_name -->
                                <td>
                                    ...
                                    <?php elseif($order->status == 'Partially shipped'): ?>
                                ...
                                <td><a href="<?php echo e(route('orders.show',$order->id)); ?>">View Order</a></td>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\owaismart\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>