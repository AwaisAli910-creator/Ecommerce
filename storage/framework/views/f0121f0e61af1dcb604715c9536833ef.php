        ...
        <div class="container">
            <div class="header-top">
                <div class="header-profile">
                    ...
                    <a href="<?php echo e(route('ordertracking.index')); ?>"><span>Track Order</span></a>
                ...
                <div class="header-contact d-none d-lg-block">
                    <a href="#">
                        ...
                        <span class="contact-number">03343485285</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="header-center-section d-none d-lg-block">
        <div class="container">
            <div class="header-center">
                <div class="logo">
                    <a href="http://owaismart.test/">
                        <img src="/frontend/assets/images/logos/logo.webp" alt="logo">
                    </a>
                </div>
                <div class="header-cart-items">
                    ...
                    <div class="header-favourite">
                        <a href="<?php echo e(route('wishlist.index')); ?>" class="cart-item">
                            <span>
                    ...
                    <div class="header-cart">
                        <a href="<?php echo e(route('cart.index')); ?>" class="cart-item">
                            <span>
            ...
            <div class="header-nav">
                ...
                <div class="header-nav-menu">
                    <ul class="menu-list">
                        ...
                        <li class="mega-menu">
                            <a href="<?php echo e(route('products.sidebar')); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('frontend.aboutus')); ?>">
...
</header><?php /**PATH C:\xampp\htdocs\owaismart\resources\views/frontend/body/header.blade.php ENDPATH**/ ?>