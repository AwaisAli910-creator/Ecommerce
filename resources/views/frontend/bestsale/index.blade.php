                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="/uploads/bestsale_img/{{$bestsale->p_img}}" class="card-img-top" alt="product-img">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">{{$bestsale->prod}} </a>
                                <div class="price">
                                    <span class="price-cut">{{$bestsale->prod_price}}</span>
                                    <span class="new-price">{{$bestsale->selling_price}}</span>
                                </div>
                            </div>
                        </div>
