...
<p class="paragraph">Fill the form below or write us. We will help you as soon as possible. <strong>Your satisfaction is our priority, and we’re here to assist you every step of the way!</strong></p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="wrapper phone">
                                            ...
                                            <div class="wrapper-content">
                                                ...
                                                <p class="paragraph">
                                                    <a href="tel:03343485285">03343485285</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="wrapper phone">
                                            ...
                                            <div class="wrapper-content">
                                                ...
                                                <p class="paragraph">
                                                    <a href="mailto:awaisal228@gmail.com">awaisal228@gmail.com</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="address">
                                            <div class="contact-address">
                                                ...
                                                <div class="address-content">
                                                    ...
                                                    <p class="paragraph">City Railway Colony iichundigar road</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="contact-map">
                                                <iframe
                                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3519.6895149604043!2d67.0106!3d24.8615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33e74e58f20d3%3A0x962d03b86c8ebf6e!2sCity%20Railway%20Colony%20II%2C%20Chundigar%20Road%2C%20Karachi%2C%20Pakistan!5e0!3m2!1sen!2sbd!4v1691924335610!5m2!1sen!2sbd"
                                                    width="524" height="206" allowfullscreen="" loading="lazy"
                                                    referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </div>
                        ...
                        <div class="review-form">
                            ...
                            <form action="{{ route('frontend.contactus') }}" method="POST">
                                ...
                                <div class="review-textarea">
                                    ...
                                    <textarea name="message" class="form-control" placeholder="Write Message..........." id="floatingTextarea" rows="3" required></textarea>
                                </div>
                                <div class="login-btn">
