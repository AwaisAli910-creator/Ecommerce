    ...
    @endif
        <div class="card">
            <div class="card-body">
                ...
                {{-- </div> --}}
                     <div class="ms-auto"><a href="{{route('color.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Color</a></div>
                </div>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{route('color.edit', $color->id)}}" class=""><i class='bx bxs-edit'></i></a>
