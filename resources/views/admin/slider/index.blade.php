    ...
    @endif
        <div class="card">
            <div class="card-body">
                ...
                {{-- </div> --}}
                     <div class="ms-auto"><a href="{{route('slider.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add Slider</a></div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: middle">
                                    <img src="/uploads/slider_img/{{$slider->img}}" style="width: 100px" alt="">
                                </td>
                                <td style="vertical-align: middle">{{$slider->heading}}</td>
                                <td style="vertical-align: middle">{{$slider->discount}}</td>
                                <td style="vertical-align: middle">
                                    <form method="post" action="{{ route('slider.updateStatus', $slider->id) }}">
                                        @csrf
                                        {{ method_field('PUT') }}
                                ...
                                <td style="vertical-align: middle">
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('slider.edit', $slider->id) }}" class=""><i class='bx bxs-edit'></i></a>
